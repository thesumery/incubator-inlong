...
public class MultipleSinkOption implements Serializable {
    ...
    public Map<String, String> getFormatOption() {
        return ImmutableMap.of(SINK_MULTIPLE_TYPE_MAP_SPARK_ENGINE_ENABLE.key(), String.valueOf(isSparkEngineEnable()));
    }
    ...
    public static class Builder {
        ...
        public MultipleSinkOption build() {
            return new MultipleSinkOption(format, sparkEngineEnable, schemaUpdatePolicy, databasePattern, tablePattern, pkAutoGenerated);
        }
    }
